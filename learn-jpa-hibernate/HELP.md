...
* The original package name 'com.inMvn.springboot.learn-jpa-hibernate' is invalid and this project uses 'com.inMvn.springboot.learnjpahibernate' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/3.0.0-M5/reference/htmlsingle/#data.sql.jdbc)
